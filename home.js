...
app.component('my-review' , {
    props: [],
    emits: ['review'],
    template: `<div class="form-popup" id="reviewForm">
    <div class="form-container">
...
<br>
    ...
    <div class="row">
        <div class="col">
            <button type="button" class="btn cancel btn-danger" onclick="closeReview()">Close</button>
        </div>
        <div class="col">
            <button type="submit" v-on:click="doReview" class="btn btn-success">Submit</button>
        </div>
    </div>
